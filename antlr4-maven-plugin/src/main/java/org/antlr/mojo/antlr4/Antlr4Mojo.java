...
public class Antlr4Mojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        processArgumentSets(argumentSets, grammarFiles, importGrammarFiles, dependencies);
    ...
    private void logDebugInformation(Log log) {
    ...
    private void processArgumentSets(List<List<String>> argumentSets, Set<File> grammarFiles, Set<File> importGrammarFiles, GrammarDependencies dependencies) throws MojoExecutionException, MojoFailureException {
        for (List<String> args : argumentSets) {
            try {
                ...
                getLog().error("The attempt to create the ANTLR 4 build tool failed, see exception report for details", e);
            ...
            try {
                ...
                getLog().error("Dependency analysis failed, see exception report for details",
                        e);
